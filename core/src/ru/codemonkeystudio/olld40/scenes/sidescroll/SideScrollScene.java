...
import ru.codemonkeystudio.olld40.sprites.player.PlayerSideScroll;

public abstract class SideScrollScene extends Scene {
    public World world;
    public PlayerSideScroll player;

    public OrthogonalTiledMapRenderer mapRenderer;
    public Box2DDebugRenderer debugRenderer;

    public SideScrollScene(GameScreen screen) {
        super(screen);
        world = new World(new Vector2(0, -16), false);
    ...
    private void createPlayer() {
        ...
        player = new PlayerSideScroll(body);
    }
